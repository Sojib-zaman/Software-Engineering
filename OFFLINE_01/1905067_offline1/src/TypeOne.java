...
public class TypeOne implements PC_Builder {
    private PC_Product object = new PC_Product();

    @Override
    public void setProcessor() {
        object.addComponent(new Intel_Core_I5());
    }
    ...
    public void setCooler() {
        object.addComponent(new CPU_cooler());
    }
